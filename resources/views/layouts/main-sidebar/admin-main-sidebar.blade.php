                ...
                <ul class="nav navbar-nav side-menu" id="sidebarnav">
                        ...
                        <ul id="students-menu" class="collapse">
                            ...
                            <li>
                                ...
                                <ul id="Students_upgrade" class="collapse">
                                    <li> <a
                                            href="{{ route('Promotions.index') }}">{{ trans('main_trans.add_Promotion') }}</a>
                                    </li>
                                    <li> <a
                            ...
                            <li>
                                ...
                                <ul id="Graduate students" class="collapse">
                                    <li> <a
                                            href="{{ route('Graduates.create') }}">{{ trans('main_trans.add_Graduate') }}</a>
                                    </li>
                                    <li> <a
                    ...
                    <li>
                        ...
                        <ul id="Parents-menu" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{ url('Parents') }}">{{ trans('main_trans.List_Parents') }}</a> </li>
                        </ul>
                    ...
                    <li>
                        ...
                        <ul id="Accounts-menu" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{ route('Fees.index') }}">{{ trans('main_trans.school_fees') }}</a> </li>
                            <li> <a href="{{ route('Fee_invoices.index') }}">{{ trans('main_trans.invoices') }}</a>
                            </li>
                            <li> <a href="{{ route('Receipts.index') }}">{{ trans('main_trans.receipt') }}</a> </li>
                            <li> <a
                                    href="{{ route('Processing_fees.index') }}">{{ trans('main_trans.processing_fee') }}</a>
                            </li>
                            <li> <a href="{{ route('Payments.index') }}">{{ trans('main_trans.payment') }}</a> </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul id="Attendance-icon" class="collapse" data-parent="#sidebarnav">
                            <li> <a
                                    href="{{ route('attendances.index') }}">{{ trans('attendance_trans.list_attendance') }}</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul id="Subjects" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{ route('subjects.index') }}">{{ trans('main_trans.list_subject') }}</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul id="Exams-icon" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{ route('quizzes.index') }}">{{ trans('main_trans.list_quizzes') }}</a>
                            </li>
                            <li> <a
                                    href="{{ route('questions.index') }}">{{ trans('main_trans.list_questions') }}</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul id="library-icon" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{ route('libraries.index') }}">{{ trans('main_trans.books') }}</a> </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul id="Onlineclasses-icon" class="collapse" data-parent="#sidebarnav">
                            <li> <a
                                    href="{{ route('online_classes.index') }}">{{ trans('main_trans.list_Onlineclasses') }}</a>
                            </li>
                        </ul>
                    </li>
