...
@section('css')
    @toastr_css
@section('title')
    {{ trans('Students_trans.add_fee_student') }}
@stop
@endsection
@section('page-header')
<!-- breadcrumb -->
                            ...
                            <div data-repeater-list="List_Fees">
                                <div data-repeater-item>
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            <label for="Name_en"
                                                class="mr-sm-2">{{ trans('Expenses_trans.fee_type') }}</label>
                                            <div class="box">
                                        ...
                                        <div class="col">
                                            <label for="Name_en"
                                                class="mr-sm-2">{{ trans('Expenses_trans.amount') }}</label>
                                            <div class="box">
                                        ...
                                        <div class="col">
                                            <label for="notes"
                                                class="mr-sm-2">{{ trans('Expenses_trans.notes') }}</label>
                                            <div class="box">
