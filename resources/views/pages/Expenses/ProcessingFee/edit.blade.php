...
@section('css')
    @toastr_css
@section('title')
    {{ trans('Expenses_trans.edit_pro_fee') }}
@stop
@endsection
@section('page-header')
<!-- breadcrumb -->
@section('PageTitle')
    {{ trans('Expenses_trans.edit_pro_fee') }} : <label style="color: red">{{ $ProcessingFee->student->Name }}</label>
@stop
<!-- breadcrumb -->
@endsection
@section('content')
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="Notes" id="exampleFormControlTextarea1" rows="3">{{ $ProcessingFee->Notes }}</textarea>
                            </div>
                        </div>
