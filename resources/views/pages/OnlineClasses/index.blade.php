                ...
                <div class="col-xl-12 mb-30">
                    <div class="card card-statistics h-100">
                        <div class="card-body">
                            ...
                            <a href="{{ route('online_classes.create') }}" class="btn btn-success" role="button"aria-pressed="true">{{ trans('onlineClasses_trans.add_class_on') }}</a>
                            <a class="btn btn-warning" href="{{ route('indirect.create') }}">{{ trans('onlineClasses_trans.add_class_of') }}</a>
                            <br/>
                            <br/>
                                        ...
                                        @foreach ($online_classes as $online_classe)
                                            <tr>
                                                ...
                                                @if($online_classe->User_id != null)
                                                    @if($online_classe->User_id == auth()->user()->id)
