    ...
    <div class="col-md-12 mb-30">
        <div class="card card-statistics h-100">
            <div class="card-body">
                ...
                <h6 style="color: red;font-family: Cairo">{{ trans('Students_trans.old_academy') }}</h6><br>
                ...
                <form method="post" action="{{ route('Promotions.store') }}">
                    ...
                    <br>
                    <h6 style="color: red;font-family: Cairo">{{ trans('Students_trans.new_academy') }}</h6><br>
