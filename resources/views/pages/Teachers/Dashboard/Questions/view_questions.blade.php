                ...
                <div class="col-xl-12 mb-30">
                    <div class="card card-statistics h-100">
                        <div class="card-body">
                            ...
                            @endforeach
                            <a href="{{ route('teacherCreateNewQuestion', $quizze->id) }}" class="btn btn-success" role="button"
                                aria-pressed="true">{{ trans('questions_trans.add_questions') }}</a>
                                    ...
                                    <tbody>
                                        @foreach ($questions as $question)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('teacherQuestions.edit', $question->id) }}"
