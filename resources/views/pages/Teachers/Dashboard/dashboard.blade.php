                        ...
                        <div class="card-body">
                            ...
                            <p class="text-muted pt-3 mb-0 mt-2 border-top">
                                <i class="fas fa-binoculars mr-1" aria-hidden="true"></i><a
                                    href="{{ route('students.show') }}" target="_blank"><span
                                        class="text-danger">{{ trans('Dashboard_trans.show_data') }}</span></a>
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-xl-6 col-lg-6 col-md-6 mb-30">
                    <div class="card card-statistics h-100">
                        <div class="card-body">
                            ...
                            <p class="text-muted pt-3 mb-0 mt-2 border-top">
                                <i class="fas fa-binoculars mr-1" aria-hidden="true"></i><a
                                    href="{{ route('sections.show') }}" target="_blank"><span
                                        class="text-danger">{{ trans('Dashboard_trans.show_data') }}</span></a>
                            </p>
                        </div>
                    </div>
